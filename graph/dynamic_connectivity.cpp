/**
 * Author: neal
 * Description: Support add/remove edges, check if two nodes is in the same component, count c.c in offline mode.
 * Time: O(nlogn)
 */
...
// It may lead to CE in some judge, consider changing it to mt19937
